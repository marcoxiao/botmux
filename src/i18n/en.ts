...
export const messages: Record<string, string> = {
  ...
  'ai.send.after_success_hint': 'If current routing says ordinary replies belong in final, put the remaining ordinary reply in final; otherwise keep using `botmux send`. If everything was already sent, make final just BOTMUX_NOTHING_TO_SEND.',
  ...
  'ai.shell.canonical_final': 'Write ordinary replies directly in final. BotMux will use this turn\'s standard delivery channel; an ordinary Lark turn owned by a progress card will update that card. Do not call `botmux send` for an ordinary final answer.',
  ...
  'ai.shell.canonical_send_scope': 'Use `botmux send` only for proactive mid-turn updates, attachments, or handing off to another bot via @mention. If it already sent the user-visible final answer, make final just `BOTMUX_NOTHING_TO_SEND` to avoid duplication; do the same when the message is not for you.',
  ...
  'ai.followup.reminder_canonical': 'Write ordinary replies directly in final. BotMux will use this turn\'s standard delivery channel; an ordinary Lark turn owned by a progress card will update that card. Use botmux send only for proactive updates, attachments, or @mentioning another bot. Only when the message is not for you make final just BOTMUX_NOTHING_TO_SEND.',
